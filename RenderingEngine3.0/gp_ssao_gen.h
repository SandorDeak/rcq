...
{
	template<>
	struct gp_create_info<GP_SSAO_GEN>
	{
		static constexpr uint32_t render_pass = RP_SSAO_MAP_GEN;
		...
		{
			"shaders/engine/ssao_gen/vert.spv",
			"shaders/engine/ssao_gen/frag.spv"
		};
